...
root.title("Made by Abhirup Sanyal")
...
Label(image=logo7, width=1, height=1).place(x=(300), y=(300))
...
def board():                            #Drawing the board, piece by piece.
                                        ...
                                        #Splash Screen.
    tkinter.messagebox.showinfo(title=None, message="TO START GAME PRESS OKAY!")
    v = 0
    z = 0
...
def roll():   #Rolling function that rolls a dice, goes again if its a six
    ...
    if TURN == True:
        ...
        if rollc == 1:
            ...
            L1 = Label(root, text=dice, fg='Black', background='blue', font=("Arial", 30, "bold"))
...
button = Button(root, text="Click Here To turn", relief="raised", font=("Arial", 15),
